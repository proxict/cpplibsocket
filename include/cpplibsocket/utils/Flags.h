...
template <typename TEnum,
          typename = typename std::enable_if<cpplibsocket::utils::detail::IsEnumClass<TEnum>::value>::type>
constexpr cpplibsocket::utils::Flags<TEnum> operator|(const TEnum flag1, const TEnum flag2) {
    return cpplibsocket::utils::Flags<TEnum>(flag1, flag2);
}
